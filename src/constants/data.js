...
export const ALL_SERVICES = [
  { abbr:"AC", name:"AC Repair & Servicing",     cat:"Electrical & Cooling",  type:"assessment", price:"GHS 25",  popular:true,  desc:"Diagnose, clean, regas, and repair all AC brands. Same-day available in most areas." },
  { abbr:"EL", name:"Electrical Repairs",          cat:"Electrical & Cooling",  type:"assessment", price:"GHS 25",  popular:false, desc:"Fault finding, socket repairs, wiring, breaker issues, and rewiring." },
  ...
  { abbr:"GR", name:"Generator Repair",            cat:"Electrical & Cooling",  type:"assessment", price:"GHS 25",  popular:false, desc:"Diagnose and fix generator faults. Servicing and maintenance packages available." },
  { abbr:"PL", name:"Plumbing Repairs",            cat:"Plumbing & Water",      type:"assessment", price:"GHS 25",  popular:true,  desc:"Leaking pipes, burst pipes, blocked drains, toilet repairs, and fixture installation." },
  ...
  { abbr:"BH", name:"Borehole & Pump Repair",      cat:"Plumbing & Water",      type:"assessment", price:"GHS 25",  popular:false, desc:"Submersible pump repair, borehole servicing, pressure tank issues." },
  ...
  { abbr:"IP", name:"Interior Painting",           cat:"Painting & Décor",      type:"assessment", price:"GHS 25",  popular:false, desc:"Walls, ceilings, trim. Emulsion, oil, or textured finishes." },
  { abbr:"EP", name:"Exterior Painting",           cat:"Painting & Décor",      type:"assessment", price:"GHS 25",  popular:false, desc:"Weather-resistant exterior coatings. Compound walls and gates included." },
  { abbr:"CP", name:"Carpentry & Woodwork",        cat:"Construction & Fixes",  type:"assessment", price:"GHS 25",  popular:false, desc:"Doors, windows, cabinets, furniture repairs, and custom woodwork." },
  { abbr:"TL", name:"Tiling & Floor Laying",       cat:"Construction & Fixes",  type:"assessment", price:"GHS 25",  popular:false, desc:"Floor and wall tiles, bathroom tiling, and grouting." },
  { abbr:"CV", name:"CCTV Installation",           cat:"Security",              type:"assessment", price:"GHS 25",  popular:true,  desc:"IP cameras, DVR setup, night vision, and remote viewing configuration." },
  ...
  { abbr:"SO", name:"Solar Panel Installation",    cat:"Energy",                type:"assessment", price:"GHS 25",  popular:false, desc:"Grid-tie and off-grid solar systems. Inverter and battery setup." },
...
export const CATS = ["All", "Electrical & Cooling", "Plumbing & Water", "Cleaning", "Painting & Décor", "Construction & Fixes", "Security", "Energy", "Mounting", "Outdoor"];
...
export const STEPS_DATA = [
  {
    ...
    detail:"Our categories are built around how Ghanaian homes actually work — from AC systems that struggle with Dumsor to polytanks that need regular cleaning.",
  ...
  },
  {
    ...
    desc:"Pay the assessment fee or full amount via MoMo. Your money goes into escrow — not to the Tasker — until you confirm the job is done.",
...
export const SUPPORT_FAQS = [
  ...
  { cat:"Bookings",  q:"Can I cancel a booking?",                         a:"Yes. Cancel before the Tasker accepts for a full refund. Cancel within 2 hours and the assessment fee is non-refundable." },
